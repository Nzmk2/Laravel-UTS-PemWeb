            ...
            <div class="p-5">
              ...
              <form action="{{ route('register.simpan') }}" method="POST" class="user">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input name="password_confirmation" type="password" class="form-control form-control-user @error('password_confirmation')is-invalid @enderror" id="exampleRepeatPassword" placeholder="Masukan Ulang Kata Sandi">
